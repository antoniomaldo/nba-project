...
public class DataServiceController {
    ...
    public ResponseEntity<?> getDayEvents() {
        if(EVENTS_CACHE.keySet().size() == 0) {
            ...
            List<MatchWithOdds> matchWithOddsList = NbaScraper.scrapeTodaysMatchesForWilliamHill();
    ...
    private static Map<String, String> getMappings() {
        ...
        map.put("Phoenix", "PHX");
        map.put("Washington", "WSH");
        map.put("Boston", "BOS");
        map.put("Milwaukee", "MIL");
        map.put("Sacramento", "SAC");
        map.put("San Antonio", "SA");
        map.put("Houston", "HOU");
        map.put("Dallas", "DAL");
        map.put("Denver", "DEN");
