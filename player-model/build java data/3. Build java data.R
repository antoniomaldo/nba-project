...
FD_CSV_DIR <- paste0( "C:\\Users\\Antonio\\Documents\\NBA\\player-model\\build java data\\data\\", Sys.Date(),"\\fd-data.csv")
...
fdData <- read.csv(paste0("C:\\Users\\Antonio\\Documents\\NBA\\player-model\\build java data\\data\\", Sys.Date(),"\\fd-data.csv"))
...
allPlayers <- allPlayers[c("PlayerId", "Position", "averageMinutes", "cumPercAttemptedPerMinute", "lastGameAttemptedPerMin", 
                           ...
                           "lastYearFtPerc", "cumFtPerc", "LastYearFTAttempted", "LastYearNumbGames", "gamesPlayedSeason", "cumFgAttemptedPerGame")]
